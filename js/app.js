...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <h3 class="custom-margin">Rating: ${product.rating.rate} (${product.rating.count})</h3>
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now custom-button-green">add to cart</button>
      <button id="details-btn" class="custom-button-ash">Details</button></div>
      `;
...
/* UPDATE DELIVERY CHARGE & TOTAL TEXT  */
